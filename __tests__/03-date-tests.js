...
describe('03-date-tasks', function() {
    ...
    it('parseDataFromRfc2822 should parse rfc2822 string into a date value', function () {
        assert.equal(
    ...
    it('parseDataFromIso8601 should parse ISO 8601 string into a date value', function () {
        assert.equal(
            1453219657000,
    ...
    it('isLeapYear should true if specified year is leap', function () {
        [
            new Date(2000,1,1),
            new Date(2012,1,1)
        ].forEach(date => {
    ...
    it('timeSpanToString should return the string represation of time span between two dates', function () {
        [
            {
    ...
    it('angleBetweenClockHands should returns the angle bettween clock hands for specified Greenwich datetime', function () {
        [
            {
