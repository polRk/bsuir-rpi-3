...
describe('02-numbers-tasks', function() {
    ...
    it('getRectangleArea should return a square of rectangle', function() {
        assert.equal(50, tasks.getRectangleArea(5, 10));
        assert.equal(25, tasks.getRectangleArea(5, 5));
    });

    it('getCicleCircumference should return a circumference of cicle', function() {
    ...
    it('getDistanceBetweenPoints should return a distance between points', function() {
    ...
    it('getAngleBetweenVectors should return a angle (in radians) between two linear vectors', function() {
    ...
    it('parseNumberFromString should return a number from the given string representation', function() {
