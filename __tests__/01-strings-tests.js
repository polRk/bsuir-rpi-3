...
describe("01-strings-tasks", function() {
  ...
  it("getStringFromTemplate should create a string from template using given parameters", function() {
  ...
  it("getFirstChar should return the first char from given string", function() {
    assert.equal("J", tasks.getFirstChar("John Doe"));
    assert.equal("c", tasks.getFirstChar("cat"));
  });

  it("extractNameFromTemplate should parse the name from given string", function() {
  ...
  it("convertToUpperCase should convert all chars from specified string into upper case", function() {
  ...
  it("getRectangleString should return the string reprentation of rectangle with specified size", function() {
    assert.equal(
      "┌────┐\n" +
      "│    │\n" +
      "│    │\n" +
  ...
  it("isString should return true if argument ia a string", function() {
    ...
    assert.equal(true, tasks.isString(new String("test")), "new String('__tests__')");
  });
