...
describe('08-objects-tasks', function() {
  it('Rectangle constructor should return the rectangle object', function() {
  ...
  it('getJSON should return the JSON representation of specified object', function() {
    [
      {
        obj: [1, 2, 3],
        expected: '[1,2,3]',
  ...
  it('fromJSON should return the object of specified type from JSON representation', function() {
  ...
  it('cssSelectorBuilder should creates css selector object with stringify() method', function() {
